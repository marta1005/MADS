...
assembly = Assembly(
    "system",
    [env, wing, engine1, engine2, configuration],
    variables,
)

# -----------------------------------------------------------------------
# define electric engine - DISCIPLINE
# -----------------------------------------------------------------------
# Engine
...
constraints = [{"name": lift_const.name, "type": "eq", "value": 0.0}]
...
# add observable
#mads_scenario.add_observable(lift_const.name)
